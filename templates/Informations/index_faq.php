<div class="row h-100">
  ...
  <div class="col-10 p-0">
    <div id="faq" class="pb-4 accountingEntries index content">
        <div class="jumbotron jumbotron-fluid p-3 mb-2">
            <div class="row px-2 mx-1">
              <h1 class="th1-1">FAQ</h1>
            </div>
        </div>
    </div>
    <div class="container-fluid">
      <div class="col-12">
      <div class="container-fluid grey-border rounded-corners p-3 mb-4">
          <div class="col-12 text-center pt-4 mt-2">
            <form class="form-inline my-2 my-lg-0">
              <input class="form-control search input-form col-11" type="search" placeholder="Je voudrais de l'aide par rapport à..." aria-label="Search">
                <i class="icon-search orange-font col-1"></i>
              </input>
            </form>
            <h2 class="orange-font th2-1 py-4 mt-2 ">Questions Fréquents</h2>
            <p class="font-weight-bold">Quels sont les documents nécessaires pour créer une association? <span class="orange-font">|</span> Comment changer d'abonnement à Hallinto ?</p>
          </div>
        </div>
      <div class="row py-3">
