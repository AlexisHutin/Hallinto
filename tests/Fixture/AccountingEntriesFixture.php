...
class AccountingEntriesFixture extends TestFixture
{
    ...
    public $fields = [
        ...
        'accounting_entry_type_id' => ['type' => 'integer', 'length' => null, 'unsigned' => false, 'null' => false, 'default' => null, 'comment' => '', 'precision' => null, 'autoIncrement' => null],
        ...
        '_indexes' => [
            ...
            'accounting_entry_type_id' => ['type' => 'index', 'columns' => ['accounting_entry_type_id'], 'length' => []],
        ],
        '_constraints' => [
            'primary' => ['type' => 'primary', 'columns' => ['id'], 'length' => []],
            'accounting_entries_ibfk_2' => ['type' => 'foreign', 'columns' => ['accounting_entry_type_id'], 'references' => ['accounting_entry_type', 'id'], 'update' => 'restrict', 'delete' => 'restrict', 'length' => []],
            'accounting_entries_ibfk_1' => ['type' => 'foreign', 'columns' => ['association_id'], 'references' => ['associations', 'id'], 'update' => 'restrict', 'delete' => 'restrict', 'length' => []],
        ],
        '_options' => [
            'engine' => 'InnoDB',
